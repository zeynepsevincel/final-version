...
function Confirmation() {
  return <h2 style={{ marginLeft: "35%", marginTop: "100px", marginBottom: "100px" }}>Your Reservation is Successful! </h2>;
}
      ...
      <div>
        ...
        <div style={{ padding: '20px' }}>
          ...
          {activeStep !== steps.length - 1 &&
            <button onClick={handleNext} style={{ marginLeft: "90%" }}>Next</button>
          }
        </div>
      </div>
